...
WiFiClient  client;
const int Write_Channel_Interval = 60;
long timeSinceLastChannelWrite = 0;

// OpenWeatherMap Settings
// Sign up here to get an API key:
// https://docs.thingpulse.com/how-tos/openweathermap-key/
String OPEN_WEATHER_MAP_APP_ID = "ID";
/*
 ...
 */
String OPEN_WEATHER_MAP_LOCATION_ID = "LID";
...
void loop() {
  ...
  if (millis() - timeSinceLastChannelWrite > (1000L*Write_Channel_Interval)) {
    writeChannel();
    timeSinceLastChannelWrite = millis();
  }
...
void writeChannel(){
  Serial.println(F("Begin to read sensor."));
  float h = dht.readHumidity();
  float t = dht.readTemperature();
  if (isnan(h) || isnan(t)) {
